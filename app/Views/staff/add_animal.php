...
<head>
    ...
    <title>Add New Animal - Staff Dashboard</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 p-0 sidebar">
                ...
                <a href="/staff/add-animal" class="sidebar-item active">
            ...
            <div class="col-md-10 main-content">
                <div class="content-card">
                    <h3 class="mb-4">
                        <i class="fas fa-plus-circle"></i> Add New Animal (Requires Admin Approval)
                    </h3>
    ...
    <script>
        ...
        document.getElementById('addAnimalForm').addEventListener('submit', function(e) {
            ...
            .then(res => {
                if (res.success) {
                    Swal.fire({icon: 'success', title: 'Success!', text: 'Animal submitted for admin approval successfully!'});
                    this.reset();
